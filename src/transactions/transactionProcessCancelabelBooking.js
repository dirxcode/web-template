...
export const transitions = {
  ...
  export const graph = {
    ...
    id: 'lendit-cancelable-booking/release-1',
    ...
    states: {
      ...
      [states.PREAUTHORIZED]: {
        on: {
          ...
          [transitions.CANCEL_BY_CUSTOMER]: states.DECLINED,
        },
      },
  ...
  export const isProviderAccepted = transition => {
    return [transitions.ACCEPT].includes(transition);
  };
